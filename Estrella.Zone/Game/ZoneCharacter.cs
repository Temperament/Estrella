...
using Estrella.Zone.Game.Guilds;
using Estrella.Zone.Game.Guilds.Academy;
using Estrella.Zone.Game.Buffs;
...
namespace Estrella.Zone.Game
{
	public class ZoneCharacter : MapObject
	{
		...
		public ZoneCharacter(int CharID, bool loadequips = true)
		{
			try
			{
				Character = Estrella.Database.DataStore.ReadMethods.ReadCharObjectByIDFromDatabase(CharID, Program.CharDBManager);
